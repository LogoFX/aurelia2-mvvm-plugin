...
import { NullOrUndefinedValueObjectPropertyError } from "./null-or-undefined-value-object-property-error";
 ...
 * @class ValueObject
 *
 * @description Represents an abstract base class for Value Objects. Value Objects are immutable and compared by their structural properties.
 *
 */
  ...
  constructor(props: T) {
    ...
    if (props === null || props === undefined) {
      throw new NullOrUndefinedValueObjectPropertyError(
        "Value Object properties cannot be null or undefined"
      );
    }
